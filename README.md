...
> A focused learning companion that turns a skill goal into a practical, one-hour session.
...
- **One-hour learning sessions** — Build a session around a target skill and goal, sequenced as Learn → Understand → Practice → Quiz → Build → Reflect.
...
- **Skill paths** — Follow beginner-to-advanced paths with goal match, difficulty progression, and hands-on coverage signals.
...
- **Mini-project challenges** — Apply a lesson through a scoped build checklist and key takeaways.
...
Built for learners who want less browsing and more progress.
